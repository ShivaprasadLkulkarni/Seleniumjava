...
//		int myList = obj1.size();
		// enhanced for loop for al no need stroe the sizxe of data
	for(Object slk:obj1) {// object iss used coz here everything is form of object thats the reason 
		System.out.println("Values are : "+slk);
	}
